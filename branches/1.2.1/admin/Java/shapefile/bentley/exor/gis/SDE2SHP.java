 ...
 *    PVCS Identifiers :-
 *
 *       sccsid           : $Header:   //new_vm_latest/archives/nm3/admin/Java/shapefile/bentley/exor/gis/SDE2SHP.java-arc   1.2.1.0   Oct 09 2018 08:00:14   Upendra.Hukeri  $
 *       Module Name      : $Workfile:   SDE2SHP.java  $
 *       Date into SCCS   : $Date:   Oct 09 2018 08:00:14  $
 *       Date fetched Out : $Modtime:   Oct 09 2018 06:53:30  $
 *       SCCS Version     : $Revision:   1.2.1.0  $
 *       Based on 
 *
 *
 *
		...
		try {
			...
			if (args.length <= 1) {
				...
				if (numOfRows > 0) {
					...
					writeLog(logger, new Date().toString() + ": no records found...");
				}
