...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3merge.pkb-arc   2.16.1.0   Jan 21 2016 09:03:18   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3merge.pkb  $
--       Date into PVCS   : $Date:   Jan 21 2016 09:03:18  $
--       Date fetched Out : $Modtime:   Jan 21 2016 09:01:08  $
--       PVCS Version     : $Revision:   2.16.1.0  $
--
--   Author : ITurnbull
--
...
-----------------------------------------------------------------------------
--
   g_body_sccsid     CONSTANT  varchar2(2000) := '"$Revision:   2.16.1.0  $"';
