...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/admin/pck/nm3inv_bau.pkb-arc   2.2.1.0   May 16 2012 15:33:52   Steve.Cooper  $
--       Module Name      : $Workfile:   nm3inv_bau.pkb  $
--       Date into PVCS   : $Date:   May 16 2012 15:33:52  $
--       Date fetched Out : $Modtime:   May 16 2012 15:23:22  $
...
--
  ...
  begin
    ...
    if not is_attr_present('IIT_END_DATE') then
      ...
      p_tbl(i).iit_inv_type              := p_inv_type;
    end if;
