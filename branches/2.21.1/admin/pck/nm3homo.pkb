...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3homo.pkb-arc   2.21.1.0   Jul 15 2016 11:04:10   Vikas.Mhetre  $
--       Module Name      : $Workfile:   nm3homo.pkb  $
--       Date into PVCS   : $Date:   Jul 15 2016 11:04:10  $
--       Date fetched Out : $Modtime:   Jul 15 2016 11:01:40  $
--       PVCS Version     : $Revision:   2.21.1.0  $
--
--
...
--
   ...
   g_body_sccsid     CONSTANT  VARCHAR2(2000) := '"$Revision:   2.21.1.0  $"';
