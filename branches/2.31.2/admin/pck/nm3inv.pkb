...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3inv.pkb-arc   2.31.2.0   Jan 29 2016 11:15:18   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3inv.pkb  $
--       Date into SCCS   : $Date:   Jan 29 2016 11:15:18  $
--       Date fetched Out : $Modtime:   Jan 29 2016 11:15:10  $
--       SCCS Version     : $Revision:   2.31.2.0  $
--       Based on --
--
--   nm3inv package body
--
...
--  g_body_sccsid is the SCCS ID for the package body
   g_body_sccsid        CONSTANT varchar2(2000) := '$Revision:   2.31.2.0  $';
...
--
   ...
   SELECT nit_inv_type, itr_mode, nad_nt_type
    FROM  NM_INV_TYPE_ROLES
         ,HIG_USER_ROLES
         ,NM_INV_TYPES, nm_nw_ad_types
...
--
   ...
   l_nad    nm_nw_ad_types.nad_nt_type%TYPE := NULL;
   l_nit_type nm_inv_types.nit_inv_type%TYPE := NULL;
--
BEGIN
--
   OPEN  cs_mode (pi_inv_type, pi_username);
   FETCH cs_mode INTO l_nit_type, l_retval, l_nad;
   CLOSE cs_mode;
--
   if l_nad is not null then
     return 'NORMAL';
   else
     RETURN l_retval;
   end if;
