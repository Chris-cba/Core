...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3rsc.pkb-arc   2.4.1.1.1.0   May 16 2013 13:00:38   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3rsc.pkb  $
--       Date into PVCS   : $Date:   May 16 2013 13:00:38  $
--       Date fetched Out : $Modtime:   May 16 2013 12:59:54  $
--       PVCS Version     : $Revision:   2.4.1.1.1.0  $
--
--   Author : R.A. Coupe
--
...
--
   g_body_sccsid     CONSTANT  varchar2(30) :='"$Revision:   2.4.1.1.1.0  $"';
