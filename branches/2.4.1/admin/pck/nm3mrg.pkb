...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3mrg.pkb-arc   2.4.1.0   Jun 14 2010 14:21:32   cstrettle  $
--       Module Name      : $Workfile:   nm3mrg.pkb  $
--       Date into PVCS   : $Date:   Jun 14 2010 14:21:32  $
--       Date fetched Out : $Modtime:   Jun 14 2010 11:17:38  $
...
*/
  ...
  g_body_sccsid   constant varchar2(200) :='"$Revision:   2.4.1.0  $"';
...
--
   ...
   --
         IF   l_rec_attrib.nqa_nqt_seq_no =  g_tab_rec_query_types(l_rec_itx.query_type_id).nqt_seq_no
          ...
          THEN
   --
   -- CWS Case change removed for branch version.
