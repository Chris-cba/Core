...
---   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3sdo.pkb-arc   2.5.2.0   Nov 10 2008 18:17:28   rcoupe  $
--       Module Name      : $Workfile:   nm3sdo.pkb  $
--       Date into PVCS   : $Date:   Nov 10 2008 18:17:28  $
--       Date fetched Out : $Modtime:   Nov 10 2008 18:16:36  $
--       PVCS Version     : $Revision:   2.5.2.0  $
--       Based on
...
-----------------------------------------------------------------------------
   ...
   g_body_sccsid     CONSTANT VARCHAR2(2000) := '"$Revision:   2.5.2.0  $"';
