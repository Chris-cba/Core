...
---   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3sdo.pkb-arc   2.71.1.0.1.0   May 30 2014 12:24:36   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3sdo.pkb  $
--       Date into PVCS   : $Date:   May 30 2014 12:24:36  $
--       Date fetched Out : $Modtime:   May 30 2014 12:22:32  $
--       PVCS Version     : $Revision:   2.71.1.0.1.0  $
--       Based on
...
-----------------------------------------------------------------------------
   ...
   g_body_sccsid     CONSTANT VARCHAR2(2000) := '"$Revision:   2.71.1.0.1.0  $"';
...
--  Nm_Debug.debug_on;
  ...
  */
  ...
  --                  nm_debug.debug( 'Geometry type = '||to_char( l_ge.nga(l_g_p).ng_geometry.sdo_gtype ));
                      ...
                      IF ABS(l_g_len - l_len.pa(l_l_p).ptr_value ) > l_usgm.diminfo(3).sdo_tolerance THEN
