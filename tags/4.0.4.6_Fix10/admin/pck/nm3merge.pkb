...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3merge.pkb-arc   2.2.1.0   Nov 09 2009 19:37:28   aedwards  $
--       Module Name      : $Workfile:   nm3merge.pkb  $
--       Date into PVCS   : $Date:   Nov 09 2009 19:37:28  $
--       Date fetched Out : $Modtime:   Nov 09 2009 19:36:14  $
...
--              --l_tab_rec_nm_final(l_tab_rec_nm_final.COUNT).nm_end_mp    := l_tab_rec_nm(i-1).nm_begin_mp;
--              ### l_tab_rec_nm(i-1).nm_end_mp   = 22.246
