...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3split.pkb-arc   2.23.1.0   Aug 11 2020 15:00:28   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3split.pkb  $
--       Date into PVCS   : $Date:   Aug 11 2020 15:00:28  $
--       Date fetched Out : $Modtime:   Aug 11 2020 14:59:50  $
...
BEGIN
  ...
  if HIG.IS_PRODUCT_LICENSED('LB') then
     ...
     begin
        ...
        execute immediate l_block using 'S', pi_ne_id, 0, pi_split_offset, 0, pi_effective_date, l_ne_rec.ne_length;
     end;
  end if;
