...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3invval.pkb-arc   2.20.1.0   May 12 2020 11:15:28   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3invval.pkb  $
--       Date into PVCS   : $Date:   May 12 2020 11:15:28  $
--       Date fetched Out : $Modtime:   May 12 2020 11:13:38  $
--       Version          : $Revision:   2.20.1.0  $
...
-- task 0111977 - clear out any shapes that may not be picked up by the member triggers. This is pure inventory so we know the date columns
