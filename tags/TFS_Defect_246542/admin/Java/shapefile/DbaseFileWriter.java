 ...
 *    PVCS Identifiers :-
 *
 *       sccsid           : $Header:   //new_vm_latest/archives/nm3/admin/Java/shapefile/DbaseFileWriter.java-arc   1.0   Aug 17 2015 07:39:32   Upendra.Hukeri  $
 *       Module Name      : $Workfile:   DbaseFileWriter.java  $
 *       Date into SCCS   : $Date:   Aug 17 2015 07:39:32  $
 *       Date fetched Out : $Modtime:   Aug 05 2015 08:25:10  $
...
public class DbaseFileWriter {
    ...
    public DbaseFileWriter(DbaseFileHeader header, WritableByteChannel out, Charset charset, TimeZone timeZone)
        ...
        for (int i = 0; i < nullValues.length; i++) {
            ...
            case 'D':
            case 'd':
                //nullChar = '0'; 	// commented out to avoid '0's for NULL Dates
                //break;			// commented out to avoid '0's for NULL Dates
            case '@':
