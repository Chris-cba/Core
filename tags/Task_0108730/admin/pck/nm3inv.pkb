...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3inv.pkb-arc   2.10.1.0   Nov 17 2009 15:48:18   aedwards  $
--       Module Name      : $Workfile:   nm3inv.pkb  $
--       Date into SCCS   : $Date:   Nov 17 2009 15:48:18  $
--       Date fetched Out : $Modtime:   Nov 17 2009 15:47:10  $
...
-----------------------------------------------------------------------------
--
   g_body_sccsid     CONSTANT  VARCHAR2(80) := '"$Revision:   2.10.1.0  $"';
