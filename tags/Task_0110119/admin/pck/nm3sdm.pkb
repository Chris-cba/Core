...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3sdm.pkb-arc   2.32.1.0   Nov 03 2010 10:11:30   Ade.Edwards  $
--       Module Name      : $Workfile:   nm3sdm.pkb  $
--       Date into PVCS   : $Date:   Nov 03 2010 10:11:30  $
--       Date fetched Out : $Modtime:   Nov 03 2010 10:10:28  $
--       PVCS Version     : $Revision:   2.32.1.0  $
--
--   Author : R.A. Coupe
--
...
--
   g_body_sccsid     CONSTANT VARCHAR2 (2000) := '"$Revision:   2.32.1.0  $"';
