...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/admin/pck/nm3_bulk_attrib_upd.pkb-arc   3.7.1.0   Jun 07 2012 10:31:18   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3_bulk_attrib_upd.pkb  $
--       Date into PVCS   : $Date:   Jun 07 2012 10:31:18  $
--       Date fetched Out : $Modtime:   Jun 07 2012 10:30:20  $
--       Version          : $Revision:   3.7.1.0  $
...
--all global package variables here
  ...
  g_body_sccsid  CONSTANT varchar2(2000) := '$Revision:   3.7.1.0  $';
   ...
   ELSE
       ...
       Loop
           ...
           SELECT l_grp_ne_id,
                  ...
                  Null    
                 BULK  COLLECT INTO l_nm_rec   
           FROM  --nm_members nm,   - RAC - task 0112033 - removal of appalling join which generally failed on insert 
