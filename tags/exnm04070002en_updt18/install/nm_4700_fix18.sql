--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/nm3/install/nm_4700_fix18.sql-arc   1.0   Mar 26 2015 08:17:44   Upendra.Hukeri  $
--       Module Name      : $Workfile:   nm_4700_fix18.sql  $ 
--       Date into PVCS   : $Date:   Mar 26 2015 08:17:44  $
--       Date fetched Out : $Modtime:   Mar 26 2015 09:20:34  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4700_fix18_&log_extension'
SPOOL &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON
PROMPT log_nm_4700_fix18.sql
--
SET FEEDBACK ON
start log_nm_4700_fix18.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
