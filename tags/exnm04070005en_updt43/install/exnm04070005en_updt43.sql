--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/nm3/install/exnm04070005en_updt43.sql-arc   1.0   Jul 19 2016 09:54:40   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070005en_updt43.sql  $ 
--       Date into PVCS   : $Date:   Jul 19 2016 09:54:40  $
--       Date fetched Out : $Modtime:   Jul 19 2016 09:53:12  $
...
--
	CURSOR c1 is
      ...
      WHERE EXISTS
              (SELECT 1
                 FROM hig_upgrades
                WHERE hup_product = 'NET' AND remarks like 'NET 4700 FIX 37%')
       AND  EXISTS
              (SELECT 1
                 FROM hig_upgrades
                WHERE hup_product = 'NET' AND remarks like 'NET 4700 FIX 21%');
