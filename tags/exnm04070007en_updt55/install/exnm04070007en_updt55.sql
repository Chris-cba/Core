--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070007en_updt55.sql-arc   1.0   Jul 04 2017 14:18:22   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070007en_updt55.sql  $ 
--       Date into PVCS   : $Date:   Jul 04 2017 14:18:22  $
--       Date fetched Out : $Modtime:   Jul 04 2017 14:16:44  $
...
Begin
  ...
  and hpr_version in ('4.2', '4,3', '4.4', '4.5', '4.7.0.0', '4.7.0.1');  
  
  update Hig_Products
  set hpr_version = '4.7.0.1'
  Where Hpr_product = 'LB';
...
--
  hig2.upgrade(p_product        => 'LB'
              ,p_upgrade_script => 'exnm04070007en_updt55.sql'
              ,p_remarks        => 'NET 4700 FIX 55 Build 7 - LB version 4.7.0.1'
              ,p_to_version     => '4.7.0.1');
--
  commit;
--
EXCEPTION
