                                                                    ...
                                                                    -1, (  nm_slk
                                                                         +   (  ne_length
                                                                           ...
                                                                           * NVL (
                                                                                ...
                                                                                1)))
                                                                    end_slk,
                                                                    case dir_flag * nm_cardinality
                                                                       when 1 then xsp
                                                                       when -1 then nvl(rvrs_xsp, xsp )
                                                                    end new_xsp,
                                                                    dir_flag * offset new_offset,
                                                                    greatest( i.start_date, m.nm_start_date ) new_start_date,
                                                                    least(i.end_date, m.nm_end_date ) new_end_date
                                                            FROM INV_IDS i,
                                                                 nm_members m,
                                                                 nm_elements e,
