...
AS
            ...
            (-------------------------------------------------------------------------
             ...
             SELECT 'S',
               ...
               FROM (SELECT n.*,
                      ...
                      WHERE n.nnu_ne_id IN
                                (TO_NUMBER (
                                     SYS_CONTEXT ('NM3SQL', 'L1_NE_ID')))) n2
              WHERE ROWNUM = 1),
        end_data
        AS
            (SELECT 'E',
               ...
               FROM (SELECT n.*,
                      ...
                      WHERE n.nnu_ne_id IN
                                (TO_NUMBER (
                                     SYS_CONTEXT ('NM3SQL', 'L2_NE_ID')))) n2
              WHERE ROWNUM = 1)
    SELECT CAST (COLLECT (lb_rpt (refnt,
      ...
      FROM (SELECT refnt,
                   ...
                   obj_id,
                   seg_id,
                   row_number() over (order by seq_id) seq_id,
                   dir_flag,
                   start_m,
                   end_m,
                   m_unit
