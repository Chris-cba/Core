...
--      Just perform a quick check to ensure the "value" data doesn't contain anything suspicious
        ...
        BEGIN
                               ...
                               AND (   LENGTH (
                                           TRIM (
                                               TRANSLATE (
                                                   ...
                                                   ' '))) >
                                       0
                                    OR UPPER (nncc_condition) NOT IN
                                           ('=',
                                            'LIKE',
                                            'NOT LIKE',
                                            '<',
            ...
            raise_application_error (
                -20001,
                'Due to potential of SQL injection the constraint cannot be evaluated');
        EXCEPTION
            WHEN NO_DATA_FOUND
            THEN
                NULL;
        ...
        SELECT NVL (
                   LISTAGG (get_constraint (ninc_id), ' AND ')
