...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/nm_4300_fix13.sql-arc   3.0   Apr 19 2011 10:45:26   Mike.Alexander  $
--       Module Name      : $Workfile:   nm_4300_fix13.sql  $
--       Date into PVCS   : $Date:   Apr 19 2011 10:45:26  $
--       Date fetched Out : $Modtime:   Apr 19 2011 10:44:50  $
...
-- Spool to Logfile
--
define logfile1='nm_4300_fix13_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT log_nm_4300_fix13.sql 
--
SET FEEDBACK ON
start log_nm_4300_fix13.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
