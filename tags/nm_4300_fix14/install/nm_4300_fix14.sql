...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/nm_4300_fix14.sql-arc   3.0   Jun 03 2011 11:16:48   Mike.Alexander  $
--       Module Name      : $Workfile:   nm_4300_fix14.sql  $
--       Date into PVCS   : $Date:   Jun 03 2011 11:16:48  $
--       Date fetched Out : $Modtime:   Jun 03 2011 11:14:54  $
...
-- Spool to Logfile
--
define logfile1='nm_4300_fix14_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT log_nm_4300_fix14.sql 
--
SET FEEDBACK ON
start log_nm_4300_fix14.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
