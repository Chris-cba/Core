...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/nm_4300_fix9.sql-arc   3.0   Mar 08 2011 14:41:22   Mike.Alexander  $
--       Module Name      : $Workfile:   nm_4300_fix9.sql  $
--       Date into PVCS   : $Date:   Mar 08 2011 14:41:22  $
--       Date fetched Out : $Modtime:   Mar 08 2011 14:40:54  $
...
-- Spool to Logfile
--
define logfile1='nm_4300_fix9_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT log_nm_4300_fix9.sql 
--
SET FEEDBACK ON
start log_nm_4300_fix9.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
