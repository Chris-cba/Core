...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3close.pkb-arc   2.7.1.0   Dec 14 2012 14:10:36   Rob.Coupe  $
--       Module Name      : $Workfile:   nm3close.pkb  $
--       Date into PVCS   : $Date:   Dec 14 2012 14:10:36  $
--       Date fetched Out : $Modtime:   Dec 14 2012 14:02:12  $
...
--      nm_debug.debug('RECORD '||TO_CHAR(i)||' '||g_tab_rte_memb_depth(i)||' '||g_tab_rte_memb_label(i)||' '||g_tab_rte_memb_child_ne_type(i)||' '||g_tab_rte_memb_child_ne_id(i)||' '||g_tab_rte_memb_end_date_flag(i));
--   END LOOP;
--
