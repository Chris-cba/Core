...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/exnm04050001en_updt46.sql-arc   1.0   Nov 30 2015 08:30:12   Steve.Cooper  $
--       Module Name      : $Workfile:   exnm04050001en_updt46.sql  $
--       Date into PVCS   : $Date:   Nov 30 2015 08:30:12  $
--       Date fetched Out : $Modtime:   Nov 26 2015 14:53:50  $
...
Begin
  ...
  And     From_Version    =   '4.5.0.0'
  And     Upgrade_Script  =   'exnsg04050006en_updt6.sql'
  And     rownum          =   1;
Exception 
  When No_Data_Found
Then
...
--
  hig2.upgrade(p_product        => 'NET'
              ,p_upgrade_script => 'exnm04050001en_updt46.sql'
