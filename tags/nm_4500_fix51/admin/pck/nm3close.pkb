...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3close.pkb-arc   2.14.1.0   Jul 13 2016 10:52:20   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3close.pkb  $
--       Date into PVCS   : $Date:   Jul 13 2016 10:52:20  $
--       Date fetched Out : $Modtime:   Jul 07 2016 15:37:28  $
--       PVCS Version     : $Revision:   2.14.1.0  $
--
--
--   Author : I Turnbull
--
...
--
   g_body_sccsid     CONSTANT  VARCHAR2(2000) := '"$Revision:   2.14.1.0  $"';
...
/*clb insert_nm_element_history ( p_ne_id          => pi_route_id
                            , p_effective_date => pi_effective_date
                            , p_neh_descr      => null
                            );
*/
