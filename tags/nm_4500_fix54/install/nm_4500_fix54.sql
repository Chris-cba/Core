...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4500_fix54.sql-arc   1.0   Jan 17 2018 15:00:16   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_4500_fix54.sql  $ 
--       Date into PVCS   : $Date:   Jan 17 2018 15:00:16  $
--       Date fetched Out : $Modtime:   Jan 16 2018 12:00:14  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4500_fix54_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
BEGIN
	...
	hig2.upgrade(p_product        => 'NET'
				      ,p_upgrade_script => 'log_nm_4500_fix54.sql'
				      ,p_remarks        => 'NET 4500 FIX 54 (Build 1)'
				      ,p_to_version     => NULL
				      );
	--
	COMMIT;
