...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4700_fix66.sql-arc   1.3   Aug 09 2019 08:06:30   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_4700_fix66.sql  $ 
--       Date into PVCS   : $Date:   Aug 09 2019 08:06:30  $
--       Date fetched Out : $Modtime:   Aug 09 2019 08:06:08  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4700_fix66_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
SET TERM ON 
PROMPT Creating Package Body nm3recal
SET TERM OFF
--
SET FEEDBACK ON
start nm3recal.pkw
...
SET TERM ON 
PROMPT Creating Package Body nm3replace
SET TERM OFF
--
SET FEEDBACK ON
...
SET TERM ON
prompt Creating Package Body lb_nw_edit if LB installed
SET TERM OFF
SET DEFINE ON
col run_file new_value run_file noprint

SELECT decode(count(*), 1, 'lb_nw_edit.pkw', 'dummy.sql') run_file
  	  FROM hig_products
...
BEGIN
	...
	hig2.upgrade(p_product        => 'NET'
				...
				,p_remarks        => 'NET 4700 FIX 66 (Build 4)'
				,p_to_version     => NULL
				);
	--
	COMMIT;
