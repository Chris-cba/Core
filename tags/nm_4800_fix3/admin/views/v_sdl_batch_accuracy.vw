...
AS
    ...
    --   PVCS Identifiers :-
    --
    --       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/views/v_sdl_batch_accuracy.vw-arc   1.5   Sep 16 2019 17:20:54   Rob.Coupe  $
    --       Module Name      : $Workfile:   v_sdl_batch_accuracy.vw  $
    --       Date into PVCS   : $Date:   Sep 16 2019 17:20:54  $
    --       Date fetched Out : $Modtime:   Sep 16 2019 17:20:04  $
    ...
    ----------------------------------------------------------------------------
           --
             ...
             MEDIAN (LEAST (slga_pct_inside, 100))
                 ...
                 median_accuracy,
             sld_working_geometry
        FROM sdl_geom_accuracy a, sdl_load_data l
