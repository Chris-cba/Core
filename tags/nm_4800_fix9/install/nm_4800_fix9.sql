...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4800_fix9.sql-arc   1.0   May 11 2021 16:45:22   Barbara.Odriscoll  $
--       Date into PVCS   : $Date:   May 11 2021 16:45:22  $
--       Module Name      : $Workfile:   nm_4800_fix9.sql  $
--       Date fetched Out : $Modtime:   May 11 2021 16:43:32  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4800_fix9_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
BEGIN
	...
	hig2.upgrade(p_product        => 'NET'
				,p_upgrade_script => 'log_nm_4800_fix9.sql'
				,p_remarks        => 'NET 4800 FIX 9 (Build 1)'
				,p_to_version     => NULL
				);
	--
	COMMIT;
