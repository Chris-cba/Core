...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4700_fix39.sql-arc   1.0   May 30 2017 16:29:46   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_4700_fix39.sql  $ 
--       Date into PVCS   : $Date:   May 30 2017 16:29:46  $
--       Date fetched Out : $Modtime:   May 04 2017 11:36:46  $
...
--------------------------------------------------------------------------------
--
DEFINE logfile1='nm_4700_fix39_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
BEGIN
	...
	hig2.upgrade(p_product        => 'NET'
				,p_upgrade_script => 'log_nm_4700_fix39.sql'
				,p_remarks        => 'NET 4700 FIX 39 (Build 1)'
				,p_to_version     => NULL
				);
	--
	COMMIT; 
