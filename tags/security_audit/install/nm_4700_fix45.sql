...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4700_fix45.sql-arc   1.0   Feb 02 2017 16:05:24   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_4700_fix45.sql  $ 
--       Date into PVCS   : $Date:   Feb 02 2017 16:05:24  $
--       Date fetched Out : $Modtime:   Dec 05 2016 10:12:50  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4700_fix45_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT Creating type nm_placement_array.tyh
SET TERM OFF
--
SET FEEDBACK ON
start nm_placement_array.tyh
SET FEEDBACK OFF

SET TERM ON 
PROMPT Creating type nm_placement_array.tyw
SET TERM OFF
--
SET FEEDBACK ON
start nm_placement_array.tyw
SET FEEDBACK OFF
...
SET TERM ON 
PROMPT creating Package Header nm3sdo.pkh
SET TERM OFF
--
SET FEEDBACK ON
START nm3sdo.pkh
...
SET TERM ON 
PROMPT creating Package Header nm3sdo_edit.pkh
SET TERM OFF
--
SET FEEDBACK ON
...
SET TERM ON 
PROMPT creating Package Body nm3homo_gis.pkw
SET TERM OFF
--
SET FEEDBACK ON
...
--
SET TERM ON 
PROMPT log_nm_4700_fix45.sql
SET TERM OFF
--
SET FEEDBACK ON
START log_nm_4700_fix45.sql
SET FEEDBACK OFF
--
SPOOL OFF
--
