...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm_4700_fix52.sql-arc   1.1   Sep 18 2017 10:39:20   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_4700_fix52.sql  $ 
--       Date into PVCS   : $Date:   Sep 18 2017 10:39:20  $
--       Date fetched Out : $Modtime:   Sep 18 2017 10:16:30  $
...
BEGIN
	...
	hig2.upgrade(p_product        => 'NET'
				...
				,p_remarks        => 'NET 4700 FIX 52 (Build 4)'
				,p_to_version     => NULL
				);
	--
	COMMIT;
