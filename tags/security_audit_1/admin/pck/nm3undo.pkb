...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3undo.pkb-arc   2.18.1.4   Oct 28 2016 13:29:34   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3undo.pkb  $
--       Date into PVCS   : $Date:   Oct 28 2016 13:29:34  $
--       Date fetched Out : $Modtime:   Oct 28 2016 13:26:58  $
--       PVCS Version     : $Revision:   2.18.1.4  $
--
--   Author : ITurnbull
--
...
-----------------------------------------------------------------------------
--
   g_body_sccsid    CONSTANT VARCHAR2 (2000) := '"$Revision:   2.18.1.4  $"';
            ...
            WHERE neh_ne_id_old = ne_id
              ...
              AND (   ne_id = c_ne_id
                   OR ne_id IN (SELECT nm_ne_id_of
                                  FROM nm_members_all
                                 WHERE nm_end_date = v_close_date
