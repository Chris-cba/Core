...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3ft_mapping.pkb	1.2 10/12/06
--       Module Name      : nm3ft_mapping.pkb
--       Date into SCCS   : 06/10/12 14:17:15
--       Date fetched Out : 07/06/13 14:11:34
--       SCCS Version     : 1.2
--
--
--   Author : M Huitson.
...
--all global package variables here
  ...
  g_body_sccsid  CONSTANT varchar2(2000) := '"@(#)nm3ft_mapping.pkb	1.1 10/06/06"';
