...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3net_api_gen.pkb	1.7 11/27/02
--       Module Name      : nm3net_api_gen.pkb
--       Date into SCCS   : 02/11/27 14:41:29
--       Date fetched Out : 07/06/13 14:12:58
--       SCCS Version     : 1.7
--
--
...
--
   g_body_sccsid     CONSTANT  varchar2(2000) := '"@(#)nm3net_api_gen.pkb	1.7 11/27/02"';
