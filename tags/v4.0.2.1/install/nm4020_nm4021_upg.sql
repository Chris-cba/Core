...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4020_nm4021_upg.sql-arc   3.0   Jul 11 2008 12:30:54   aedwards  $
--       Module Name      : $Workfile:   nm4020_nm4021_upg.sql  $
--       Date into PVCS   : $Date:   Jul 11 2008 12:30:54  $
--       Date fetched Out : $Modtime:   Jul 11 2008 12:28:02  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4020_nm4021_1_&log_extension'
define logfile2='nm4020_nm4021_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4020_nm4021_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4020_nm4021_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4020_nm4021_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.1','4.0.2.1');
      hig2.upgrade('NET','nm4020_nm4021_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.1','4.0.2.1');
      hig2.upgrade('DOC','nm4020_nm4021_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.1','4.0.2.1');
      hig2.upgrade('AST','nm4020_nm4021_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.1','4.0.2.1');
      hig2.upgrade('WMP','nm4020_nm4021_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.1','4.0.2.1');
END;
/
COMMIT;
SET HEADING OFF
