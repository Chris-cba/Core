...
--
  EXECUTE IMMEDIATE
    ...
    '-- '||chr(10)||
    '--       PVCS id          : $Header:   //vm_latest/archives/nm3/admin/trg/user_sdo_styles_ins_trg.trg-arc   3.2   Dec 05 2008 12:00:58   aedwards  $ '||chr(10)||
    '--       Module Name      : $Workfile:   user_sdo_styles_ins_trg.trg  $ '||chr(10)||
    '--       Date into PVCS   : $Date:   Dec 05 2008 12:00:58  $ '||chr(10)||
    '--       Date fetched Out : $Modtime:   Dec 05 2008 09:20:46  $ '||chr(10)||
