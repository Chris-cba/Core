...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4050_nm4051_upg.sql-arc   3.0   Oct 29 2008 14:59:10   malexander  $
--       Module Name      : $Workfile:   nm4050_nm4051_upg.sql  $
--       Date into PVCS   : $Date:   Oct 29 2008 14:59:10  $
--       Date fetched Out : $Modtime:   Oct 29 2008 14:55:58  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4050_nm4051_1_&log_extension'
define logfile2='nm4050_nm4051_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4050_nm4051_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4050_nm4051_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4050_nm4051_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.1','4.0.5.1');
      hig2.upgrade('NET','nm4050_nm4051_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.1','4.0.5.1');
      hig2.upgrade('DOC','nm4050_nm4051_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.1','4.0.5.1');
      hig2.upgrade('AST','nm4050_nm4051_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.1','4.0.5.1');
      hig2.upgrade('WMP','nm4050_nm4051_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.1','4.0.5.1');
END;
/
COMMIT;
SET HEADING OFF
