...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4052_nm4053_upg.sql-arc   3.0   Mar 02 2009 12:27:56   malexander  $
--       Module Name      : $Workfile:   nm4052_nm4053_upg.sql  $
--       Date into PVCS   : $Date:   Mar 02 2009 12:27:56  $
--       Date fetched Out : $Modtime:   Feb 11 2009 11:23:32  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4052_nm4053_1_&log_extension'
define logfile2='nm4052_nm4053_2_&log_extension'
spool &logfile1
--get some db info
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4052_nm4053_upg.sql','Upgrade from 4.0.5.2 to 4.0.5.3','4.0.5.3');
      hig2.upgrade('NET','nm4052_nm4053_upg.sql','Upgrade from 4.0.5.2 to 4.0.5.3','4.0.5.3');
      hig2.upgrade('DOC','nm4052_nm4053_upg.sql','Upgrade from 4.0.5.2 to 4.0.5.3','4.0.5.3');
      hig2.upgrade('AST','nm4052_nm4053_upg.sql','Upgrade from 4.0.5.2 to 4.0.5.3','4.0.5.3');
      hig2.upgrade('WMP','nm4052_nm4053_upg.sql','Upgrade from 4.0.5.2 to 4.0.5.3','4.0.5.3');
END;
/
COMMIT;
SET HEADING OFF
