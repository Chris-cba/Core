...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4053_nm4054_upg.sql-arc   3.0   Mar 23 2009 12:22:30   malexander  $
--       Module Name      : $Workfile:   nm4053_nm4054_upg.sql  $
--       Date into PVCS   : $Date:   Mar 23 2009 12:22:30  $
--       Date fetched Out : $Modtime:   Mar 11 2009 09:05:14  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4053_nm4054_1_&log_extension'
define logfile2='nm4053_nm4054_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'HIG'
                          ,p_new_version           => '4.0.5.4'
                          ,p_allowed_old_version_1 => '4.0.5.3'
                          );
END;
/
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4053_nm4054_upg.sql','Upgrade from 4.0.5.3 to 4.0.5.4','4.0.5.4');
      hig2.upgrade('NET','nm4053_nm4054_upg.sql','Upgrade from 4.0.5.3 to 4.0.5.4','4.0.5.4');
      hig2.upgrade('DOC','nm4053_nm4054_upg.sql','Upgrade from 4.0.5.3 to 4.0.5.4','4.0.5.4');
      hig2.upgrade('AST','nm4053_nm4054_upg.sql','Upgrade from 4.0.5.3 to 4.0.5.4','4.0.5.4');
      hig2.upgrade('WMP','nm4053_nm4054_upg.sql','Upgrade from 4.0.5.3 to 4.0.5.4','4.0.5.4');
END;
/
COMMIT;
SET HEADING OFF
