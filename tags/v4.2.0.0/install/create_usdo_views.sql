...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/create_usdo_views.sql-arc   3.0   Aug 21 2009 15:22:34   aedwards  $
--       Module Name      : $Workfile:   create_usdo_views.sql  $
--       Date into PVCS   : $Date:   Aug 21 2009 15:22:34  $
--       Date fetched Out : $Modtime:   Aug 21 2009 15:17:06  $
...
--
  EXECUTE IMMEDIATE
    ...
    '-- '||chr(10)||
    '--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/create_usdo_views.sql-arc   3.0   Aug 21 2009 15:22:34   aedwards  $ '||chr(10)||
    '--       Module Name      : $Workfile:   create_usdo_views.sql  $ '||chr(10)||
    '--       Date into PVCS   : $Date:   Aug 21 2009 15:22:34  $ '||chr(10)||
    '--       Date fetched Out : $Modtime:   Aug 21 2009 15:17:06  $ '||chr(10)||
    '--       Version          : $Revision:   3.0  $ '||chr(10)||
