...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4200_nm4210.sql-arc   3.0   Apr 12 2010 16:28:46   malexander  $
--       Module Name      : $Workfile:   nm4200_nm4210.sql  $
--       Date into PVCS   : $Date:   Apr 12 2010 16:28:46  $
--       Date fetched Out : $Modtime:   Apr 12 2010 16:27:52  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4200_nm4210_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
