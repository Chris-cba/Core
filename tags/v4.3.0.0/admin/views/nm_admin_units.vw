...
WHERE  nau_start_date <= (select nm3context.get_effective_date from dual)
 AND   NVL(nau_end_date,TO_DATE('99991231','YYYYMMDD')) >  (select nm3context.get_effective_date from dual)
/
