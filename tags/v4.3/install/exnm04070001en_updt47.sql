--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070001en_updt47.sql-arc   1.1   Sep 16 2016 22:54:28   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070001en_updt47.sql  $ 
--       Date into PVCS   : $Date:   Sep 16 2016 22:54:28  $
--       Date fetched Out : $Modtime:   Sep 16 2016 22:54:16  $
...
values ('V_LB_TYPE_NW_FLAGS', 'VIEW' );
...
prompt package body lb_get.pkb
...
--
SET TERM ON
PROMPT log_nm_4700_fix47.sql
--
SET FEEDBACK ON
start log_nm_4700_fix47.sql
SET FEEDBACK OFF
SPOOL OFF
