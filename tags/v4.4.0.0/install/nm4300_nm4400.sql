...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4300_nm4400.sql-arc   3.0   Jan 20 2011 17:05:04   Mike.Alexander  $
--       Module Name      : $Workfile:   nm4300_nm4400.sql  $
--       Date into PVCS   : $Date:   Jan 20 2011 17:05:04  $
--       Date fetched Out : $Modtime:   Jan 20 2011 09:59:08  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4300_nm4400_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
