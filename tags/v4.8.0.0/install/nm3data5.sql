...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm3data5.sql-arc   2.18   May 17 2018 16:16:40   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3data5.sql  $
--       Date into PVCS   : $Date:   May 17 2018 16:16:40  $
--       Date fetched Out : $Modtime:   May 17 2018 15:22:26  $
...
SELECT 64
      ...
      ,'NM3NET_LOAD.VALIDATE_RESIZE_ROUTE'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 64);
...
SELECT 501
      ...
      ,'NM3NET_LOAD.VALIDATE_RESCALE_ROUTE'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 501);
...
SELECT 502
      ...
      ,'NM3NET_LOAD.VALIDATE_RESEQ_ROUTE'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 502);
...
SELECT 503
      ...
      ,'NM3NET_LOAD.VALIDATE_DISTANCE_BREAK'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 503);
...
SELECT 1172
      ...
      ,'nm3inv_load.validate_ele_mp_ambig'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 1172);
...
SELECT 1173
      ...
      ,'nm3inv_load.validate_ele_mp_excl'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 1173);
...
SELECT 1174
      ...
      ,'nm3inv_load.validate_on_element'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATIONS
                   WHERE NLD_ID = 1174);
...
--
INSERT
  INTO NM_LOAD_DESTINATION_DEFAULTS
      (NLDD_NLD_ID
      ,NLDD_COLUMN_NAME
      ,NLDD_VALUE)
SELECT 34
...
SELECT 1063
      ,'NAU_ADMIN_UNIT'
      ,'nm3seq.next_NAU_ADMIN_UNIT_SEQ'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATION_DEFAULTS
...
SELECT 1088
      ,'ITB_BANDING_ID'
      ,'nm3seq.next_ITB_BANDING_ID_SEQ'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_LOAD_DESTINATION_DEFAULTS
...
--
INSERT
  INTO NM_UPLOAD_FILE_GATEWAY_COLS
