...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm3data7.sql-arc   2.28   May 17 2018 16:16:42   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3data7.sql  $
--       Date into PVCS   : $Date:   May 17 2018 16:16:42  $
--       Date fetched Out : $Modtime:   May 17 2018 15:22:30  $
...
SELECT 'HIG'
      ...
      ,'A required file is missing from your working directory/path'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'HIG'
...
SELECT 'HIG'
      ...
      ,'Associated Data rules are not in place to support linking this network element to this asset type'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'HIG'
...
SELECT 'HIG'
      ...
      ,'You are not permitted to read data from the specified directory'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'HIG'
...
SELECT 'HIG'
      ...
      ,'You are not permitted to write data to the specified directory'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'HIG'
...
SELECT 'HIG'
      ...
      ,null
      ,'XML Read error'
      ,'Error suggests XML is not ''well formed'''
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'HIG'
...
SELECT 'NET'
      ...
      ,'ACTION: This is an internal error message and should not normally be'||CHR(10)||'issued. Contact your ORACLE Customer Support Representative.'||CHR(10)||''
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'ACTION: All associated records should be deleted before the record that'||CHR(10)||'you are trying to delete can be deleted.'||CHR(10)||''
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'ACTION: Records cannot be duplicated in this block.'||CHR(10)||''
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ,360
      ,null
      ,'Position coincides with node(s). Do you wish to split at a node?'
      ,''
  FROM DUAL;
--
DELETE FROM NM_ERRORS
...
SELECT 'NET'
      ...
      ,'A parent sub-type has been defined that is not a sub-type within the same admin type.  Check sub-type rules.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The following invalid scenario has occurred....'||CHR(10)||'Sub-Type X    Parent Y'||CHR(10)||'Sub-Type Y   Parent X'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The admin type for the specified group type must match the admin type for sub-type.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The sub-type specified for the admin unit does not exist in the sub-type rules.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'A group type to police cannot be specified in the sub-type rules if elements of that group type already exist.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Admin unit has been applied to an element which has a confling group type in the admin sub-type rules.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Admin type has an admin type grouping of ''LOCKED'' which prevents insert/update/delete operations on admin units of this type.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Flexible attribute query does not parse.  Check the query syntax.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'A specified value is invalid for an attribute.  If applicable, use a list of values to select a valid value. '
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Flexible attribute select statement must contain three columns.'||CHR(10)||'(1)ID - not shown in list of values but returned back to calling module'||CHR(10)||'(2)MEANING - shown in the list of values'||CHR(10)||'(3)CODE - shown in the list of values'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'More than the permitted 1 bind variable has been specified.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The bind variable specified in the flexible attribute query is not a network type column for this given network type.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The bind variable specified in the flexible attribute query is not a attribute for this given inventory type.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'''%'' has been specified against an attribute that is used to restrict the allowable values for the current attribute.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The bind variable specified in the flexible attribute query appears after the current attribute, so cannot be used to restrict by.  Possibly re-sequence the flexible attributes.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'A domain and a query have both been specified.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,null
      ,'Duplicate file name'
      ,'The filename specified is already loaded.'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'There has been a problem mapping the attributes for display. Check the inventory metadata'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,null
      ,'Out of Memory'
      ,'There is not sufficient memory available to display the results. Consider restricting the search'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Network/Group type of element 1 is not compatible with Network/Group type of element 2'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Network/Group type does not have a linear parent'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'The procedure to call reports through an Application Server has been called and has no reports server defined'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Suggest toggle group type reversable flag'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'More restrictive query criteria are required'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
...
SELECT 'NET'
      ...
      ,'Use a route with the datum in and then select the offset you require'
  FROM DUAL;
--
DELETE FROM NM_ERRORS
 WHERE NER_APPL = 'NET'
