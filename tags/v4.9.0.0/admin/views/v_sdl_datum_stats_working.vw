...
AS
    ...
    --   PVCS Identifiers :-
                                                                            --
         --       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/views/v_sdl_datum_stats_working.vw-arc   1.1   Mar 10 2020 16:42:34   Rob.Coupe  $
         --       Module Name      : $Workfile:   v_sdl_datum_stats_working.vw  $
         --       Date into PVCS   : $Date:   Mar 10 2020 16:42:34  $
         --       Date fetched Out : $Modtime:   Mar 10 2020 16:41:36  $
...
*/
         sld_key,
         datum_id,
         TO_NUMBER (SYS_CONTEXT ('NM3SQL', 'SDL_BUFFER_SIZE'))     buffer_size,
         pctage_accuracy,
         min_dist,
         max_dist
    FROM (  SELECT sld_key,
