...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm3_ddl_upg.sql-arc   1.0   Jun 01 2020 14:14:56   Chris.Baugh  $
--       Module Name      : $Workfile:   nm3_ddl_upg.sql  $
--       Date into PVCS   : $Date:   Jun 01 2020 14:14:56  $
--       Date fetched Out : $Modtime:   Apr 23 2020 10:08:44  $
...
DECLARE
  obj_exists EXCEPTION;
  cols_indexed EXCEPTION;
  PRAGMA exception_init( obj_exists, -955);
  PRAGMA exception_init( cols_indexed, -1408);
BEGIN
...
------------------------------------------------------------------
SET TERM ON
PROMPT Spatial Data Loader DDL
SET TERM OFF
