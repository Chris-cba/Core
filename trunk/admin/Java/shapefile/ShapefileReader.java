 ...
 *    PVCS Identifiers :-
 *
 *       sccsid           : $Header:   //new_vm_latest/archives/nm3/admin/Java/shapefile/ShapefileReader.java-arc   1.0   Oct 09 2017 11:14:26   Upendra.Hukeri  $
 *       Module Name      : $Workfile:   ShapefileReader.java  $
 *       Date into SCCS   : $Date:   Oct 09 2017 11:14:26  $
 *       Date fetched Out : $Modtime:   Oct 09 2017 11:13:38  $
 *       SCCS Version     : $Revision:   1.0  $
 *       Based on 
 *
 *
 *
 *    Updated by : Upendra Hukeri
...
public class ShapefileReader implements FileReader {
    ...
    private boolean hasNext(boolean checkRecno) throws IOException {
        ...
        if(currentShape > UNKNOWN && shxReader != null && currentShape > shxReader.getRecordCount() - 1)
            return false;
