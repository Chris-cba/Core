...
AS
   --   PVCS Identifiers :-
   --
   --       pvcsid           : $Header:   //new_vm_latest/archives/lb/admin/pck/lb_path.pkb-arc   1.2   Jun 18 2015 10:49:20   Rob.Coupe  $
   --       Module Name      : $Workfile:   lb_path.pkb  $
   --       Date into PVCS   : $Date:   Jun 18 2015 10:49:20  $
   --       Date fetched Out : $Modtime:   Jun 18 2015 10:48:44  $
   ...
   BEGIN
      ...
      SELECT CAST (COLLECT (lb_rpt (refnt,
        ...
        FROM (--select * from (
              SELECT refnt,
                     ...
                     dir_flag,
                     CASE
                        WHEN (s_inc_flag = 1 AND refnt = l1.lr_ne_id)
                        THEN
                           CASE dir_flag WHEN 1 THEN l1.lr_offset ELSE 0 END
                        WHEN (e_inc_flag = 1 AND refnt = l2.lr_ne_id)
                        THEN
                           CASE dir_flag WHEN 1 THEN 0 ELSE l2.lr_offset END
                        ELSE
                           start_m
                     END
                        start_m,
                      ...
                      SELECT *
                        FROM (SELECT te.refnt,
                              ...
                              SELECT l1.lr_ne_id refnt,
                                     ...
                                     0 seq_id,
                                     CASE
                                        WHEN     s_inc_flag IS NULL
                                             AND e_inc_flag IS NULL
                                             AND l1.lr_ne_id = l2.lr_ne_id
                                        THEN
                                           CASE
                                              WHEN l1.lr_offset <=
                                                      l2.lr_offset
                                     ...
                                     CASE
                                        WHEN     s_inc_flag IS NULL
                                             ...
                                             AND l1.lr_ne_id = l2.lr_ne_id
                                        THEN
                                           LEAST (l1.lr_offset, l2.lr_offset)
                                        ELSE
                                           CASE nnu_node_type
                                              WHEN 'S' THEN 0
                                              WHEN 'E' THEN l1.lr_offset
                                           END
                                     END
                                        start_m,
                                     CASE
      ...
      --group by s_inc_flag, e_inc_flag, start_node, end_node;
