...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3inv_ft.pkb	1.5 09/30/02
--       Module Name      : nm3inv_ft.pkb
--       Date into SCCS   : 02/09/30 10:16:40
--       Date fetched Out : 07/06/13 14:12:01
--       SCCS Version     : 1.5
--
--
...
--
   g_body_sccsid     CONSTANT  VARCHAR2(2000) := '"@(#)nm3inv_ft.pkb	1.5 09/30/02"';
