...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/nm3/admin/pck/nm3lock_gen.pkb-arc   2.2   Jul 20 2007 14:00:44   gjohnson  $
...
--
--
--   Function to lock using GRS_PK constraint
--
FUNCTION lock_grs (pi_grs_line_no       gri_spool.grs_line_no%TYPE
...
BEGIN
--
   nm_debug.proc_start(g_package_name,'lock_grs');
--
   OPEN  cs_grs;
...
--
   ...
   END IF;
--
   nm_debug.proc_end(g_package_name,'lock_grs');
--
   RETURN l_retval;
--
EXCEPTION
...
--
--
--   Procedure to lock using GRS_PK constraint
--
PROCEDURE lock_grs (pi_grs_line_no       gri_spool.grs_line_no%TYPE
                   ,pi_grs_job_id        gri_spool.grs_job_id%TYPE
                   ,pi_raise_not_found   BOOLEAN     DEFAULT TRUE
                   ,pi_not_found_sqlcode PLS_INTEGER DEFAULT -20000
                   ,pi_locked_sqlcode    PLS_INTEGER DEFAULT -20000
