...
--
SET TERM ON 
PROMPT nm3sdo_wms.pkw
SET TERM OFF
SET DEFINE ON 
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'nm3sdo_wms.pkw' run_file
FROM dual 
/ 
start '&run_file'
--
...
--
SET TERM ON 
PROMPT nm3_msv_util.pkw
SET TERM OFF
SET DEFINE ON 
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'nm3_msv_util.pkw' run_file
FROM dual 
/ 
start '&run_file'
--
...
--
SET TERM ON 
PROMPT hig_sso_api.pkw
SET TERM OFF
SET DEFINE ON 
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'hig_sso_api.pkw' run_file
FROM dual 
/ 
start '&run_file'
--
...
--
SET TERM ON 
PROMPT hig_relationship_api.pkw
SET TERM OFF
SET DEFINE ON 
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'hig_relationship_api.pkw' run_file
FROM dual 
/ 
start '&run_file'
--
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_ops.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_ref.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_reg.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_path.pkw' run_file 
FROM dual
/
start '&run_file'

SET TERM ON
PROMPT lb_path_reg.pkw                                                                                                                                                                                                                    
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_path_reg.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_get.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_load.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_loc.pkw' run_file 
FROM dual
/
start '&run_file'

SET TERM ON
PROMPT lb_net_code.pkw                                                                                                                                                                                                                    
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_net_code.pkw' run_file 
FROM dual
/
start '&run_file'

SET TERM ON
PROMPT lb_nw_edit.pkw                                                                                                                                                                                                                    
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_nw_edit.pkw' run_file 
FROM dual
/
start '&run_file'
...
SET TERM OFF
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'pck'||'&terminator'||'lb_aggr.pkw' run_file 
FROM dual
/
start '&run_file'
