...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/admin/pck/nm3user_admin.pkb-arc   3.5   Apr 16 2018 09:23:44   Gaurav.Gaurkar  $
...
------------------------------------------------------------------
  ...
  gc_Body_Version  Constant  Varchar2(100) := '$Revision:   3.5  $';
