...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm_debug_autonomous.pkb	1.1 04/04/02
--       Module Name      : nm_debug_autonomous.pkb
--       Date into SCCS   : 02/04/04 11:00:07
...
--
   g_body_sccsid     CONSTANT  varchar2(2000) := '"@(#)nm_debug_autonomous.pkb	1.1 04/04/02"';
