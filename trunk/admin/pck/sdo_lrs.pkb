...
AS
   ...
   END get_body_version;
    ...
    BEGIN
        IF NM_SDO.is_connected (geom_segment_1,
           ...
           0
        THEN
            RETURN NM_SDO.CONCAT_GEOM (geom_segment_1,
                                       geom_segment_2,
                                       'TRUE');
        ELSE
            RETURN NM_SDO.CONCAT_GEOM (geom_segment_1,
   ...
   RETURN MDSYS.SDO_GEOMETRY DETERMINISTIC PARALLEL_ENABLE is
begin
   return NM_SDO.PROJECT_PT(geom_segment, point, dim_array(1).sdo_tolerance );
end;
...
begin
   ...
   RETURN MDSYS.SDO_GEOMETRY DETERMINISTIC PARALLEL_ENABLE is
begin
   return NM_SDO.PROJECT_PT(geom_segment, point, dim_array(1).sdo_tolerance, offset );
end;
...
begin
   return NM_SDO.PROJECT_PT(geom_segment, point, tolerance, offset );
end;
