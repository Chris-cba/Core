...
--
  EXECUTE IMMEDIATE
    ...
    '-- '||chr(10)||
    '--       PVCS id          : $Header:   //vm_latest/archives/nm3/admin/trg/user_sdo_themes_ins_trg.trg-arc   3.2   Dec 05 2008 12:01:00   aedwards  $'||chr(10)||
    '--       Module Name      : $Workfile:   user_sdo_themes_ins_trg.trg  $'||chr(10)||
    '--       Date into PVCS   : $Date:   Dec 05 2008 12:01:00  $'||chr(10)||
    '--       Date fetched Out : $Modtime:   Dec 05 2008 09:50:56  $'||chr(10)||
