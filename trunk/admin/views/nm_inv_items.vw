...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/admin/views/nm_inv_items.vw-arc   2.10   May 18 2018 10:01:36   Chris.Baugh  $
--       Module Name      : $Workfile:   nm_inv_items.vw  $
--       Date into PVCS   : $Date:   May 18 2018 10:01:36  $
--       Date fetched Out : $Modtime:   May 18 2018 10:00:30  $
...
--
   ...
   append ('--');
   append ('--       pvcsid           : $Header:   //new_vm_latest/archives/nm3/admin/views/nm_inv_items.vw-arc   2.10   May 18 2018 10:01:36   Chris.Baugh  $');
   append ('--       Module Name      : $Workfile:   nm_inv_items.vw  $');
   append ('--       Date into PVCS   : $Date:   May 18 2018 10:01:36  $');
   append ('--       Date fetched Out : $Modtime:   May 18 2018 10:00:30  $');
   append ('--       PVCS Version     : $Revision:   2.10  $');
