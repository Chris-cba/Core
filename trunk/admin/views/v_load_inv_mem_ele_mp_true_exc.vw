CREATE OR REPLACE FORCE VIEW v_load_inv_mem_ele_mp_true_exc AS
SELECT
--   SCCS Identifiers :-
--
--       sccsid           : @(#)v_load_inv_mem_ele_mp_true_exc.vw	1.2 12/03/03
--       Module Name      : v_load_inv_mem_ele_mp_true_exc.vw
--       Date into SCCS   : 03/12/03 10:04:35
