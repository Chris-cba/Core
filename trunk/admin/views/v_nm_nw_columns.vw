...
comment on  column v_nm_nw_columns.domain is 'A pointer to the domain ID used for LOV/validation values are in HIG_CODES for direct NW attributes and NM_INV_ATTRI_LOOKUP for AD data';
