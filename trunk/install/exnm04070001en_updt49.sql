--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070001en_updt49.sql-arc   1.0   Oct 28 2016 16:31:16   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070001en_updt49.sql  $ 
--       Date into PVCS   : $Date:   Oct 28 2016 16:31:16  $
--       Date fetched Out : $Modtime:   Oct 28 2016 14:53:20  $
...
--  LB is installed, add the product code
      begin
        ...
        values ('LB', 'Location Bridge', '4.4', '76', 99);  
      exception
	    when dup_val_on_index then
		  update hig_products set hpr_version = '4.4' where hpr_product = 'LB';
      end;
--    else
...
--
SET TERM ON
PROMPT Logging the upgrade - log_nm_4700_fix49.sql
--
SET FEEDBACK ON
start log_nm_4700_fix49.sql
SET FEEDBACK OFF
SPOOL OFF
