--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070004en_updt55.sql-arc   1.0   Apr 21 2017 17:24:54   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070004en_updt55.sql  $ 
--       Date into PVCS   : $Date:   Apr 21 2017 17:24:54  $
--       Date fetched Out : $Modtime:   Apr 21 2017 17:24:40  $
...
--
  hig2.upgrade(p_product        => 'LB'
              ...
              ,p_remarks        => 'NET 4700 FIX 55 Build 4 - LB version 4.6'
              ,p_to_version     => '4.6');
--
  commit;
--
