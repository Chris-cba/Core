--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070006en_updt55.sql-arc   1.0   Jun 16 2017 13:28:46   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070006en_updt55.sql  $ 
--       Date into PVCS   : $Date:   Jun 16 2017 13:28:46  $
--       Date fetched Out : $Modtime:   Jun 16 2017 13:24:22  $
...
--
  hig2.upgrade(p_product        => 'LB'
              ,p_upgrade_script => 'exnm04070006en_updt55.sql'
              ,p_remarks        => 'NET 4700 FIX 55 Build 6 - LB version 4.7.0.0'
