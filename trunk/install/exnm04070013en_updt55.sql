...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070013en_updt55.sql-arc   1.0   Jul 12 2018 16:48:30   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070013en_updt55.sql  $
--       Date into PVCS   : $Date:   Jul 12 2018 16:48:30  $
--       Date fetched Out : $Modtime:   Jul 12 2018 16:18:40  $
...
BEGIN
    ...
    hig2.upgrade (
        p_product          => 'LB',
        p_upgrade_script   => 'exnm04070013en_updt55.sql',
        p_remarks          => 'NET 4700 FIX 55 Build 13 - LB version 4.7.0.7',
        p_to_version       => '4.7.0.7');
    --
    COMMIT;
--
EXCEPTION
