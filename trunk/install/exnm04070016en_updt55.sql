...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070016en_updt55.sql-arc   1.0   Aug 03 2018 08:25:16   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070016en_updt55.sql  $
--       Date into PVCS   : $Date:   Aug 03 2018 08:25:16  $
--       Date fetched Out : $Modtime:   Aug 03 2018 08:21:34  $
...
BEGIN
    ...
    hig2.upgrade (
        p_product          => 'LB',
        p_upgrade_script   => 'exnm04070016en_updt55.sql',
        p_remarks          => 'NET 4700 FIX 55 Build 14 - LB version 4.7.0.10',
        p_to_version       => '4.7.0.10');
    --
    COMMIT;
--
EXCEPTION
