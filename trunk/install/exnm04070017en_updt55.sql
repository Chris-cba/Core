...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //new_vm_latest/archives/lb/install/exnm04070017en_updt55.sql-arc   1.0   Sep 21 2018 08:40:28   Rob.Coupe  $
--       Module Name      : $Workfile:   exnm04070017en_updt55.sql  $
--       Date into PVCS   : $Date:   Sep 21 2018 08:40:28  $
--       Date fetched Out : $Modtime:   Aug 03 2018 13:57:04  $
...
BEGIN
    ...
    hig2.upgrade (
        p_product          => 'LB',
        p_upgrade_script   => 'exnm04070017en_updt55.sql',
        p_remarks          => 'NET 4700 FIX 55 Build 17 - LB version 4.7.0.11',
        p_to_version       => '4.7.0.11');
    --
    COMMIT;
--
EXCEPTION
