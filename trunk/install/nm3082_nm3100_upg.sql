...
REM @(#)nm3082_nm3100_upg.sql	1.2 01/08/04
--
...
begin
   hig2.pre_upgrade_check (p_product               => 'HIG'
                          ...
                          ,p_allowed_old_version_1 => '3.0.8.2'
                          );
END;
/
...
BEGIN
   ...
   FOR i IN 1..l_tab_prod.COUNT
    LOOP
      hig2.upgrade(l_tab_prod(i),'nm3082_nm3100_upg.sql','Upgrade from 3.0.8.2 to 3.1.0.0','3.1.0.0');
   END LOOP;
END;
/
COMMIT;
