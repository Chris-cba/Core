...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3110_nm3120_upg.sql	1.1 07/14/04
--       Module Name      : nm3110_nm3120_upg.sql
--       Date into SCCS   : 04/07/14 15:11:10
...
define logfile1='nm3110_nm3120_1_&log_extension'
define logfile2='nm3110_nm3120_2_&log_extension'
spool &logfile1
...
select '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm3110_nm3120_ddl_upg.sql' run_file
from dual
/
SET FEEDBACK ON
start &&run_file
...
BEGIN
   ...
   FOR i IN 1..l_tab_prod.COUNT
    LOOP
      hig2.upgrade(l_tab_prod(i),'nm3110_nm3120_upg.sql','Upgrade from 3.1.1.0 to 3.1.2.0','3.1.2.0');
   END LOOP;
END;
/
COMMIT;
