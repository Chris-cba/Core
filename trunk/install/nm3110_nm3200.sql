...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3110_nm3200.sql	1.2 01/20/05
--       Module Name      : nm3110_nm3200.sql
--       Date into SCCS   : 05/01/20 10:57:06
--       Date fetched Out : 07/06/13 13:57:47
--       SCCS Version     : 1.2
--
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3110_nm3200_upg','exit') run_file
FROM dual
/
START '&run_file'
