...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3120_nm3200_upg.sql	1.1 01/20/05
--       Module Name      : nm3120_nm3200_upg.sql
--       Date into SCCS   : 05/01/20 11:08:45
--       Date fetched Out : 07/06/13 13:57:52
--       SCCS Version     : 1.1
--
...
define logfile1='nm3120_nm3200_1_&log_extension'
define logfile2='nm3120_nm3200_2_&log_extension'
spool &logfile1
...
BEGIN
      hig2.upgrade('HIG','nm3120_nm3200_upg.sql','Upgrade from 3.1.2.0 to 3.2.0.0','3.2.0.0');
      hig2.upgrade('NET','nm3120_nm3200_upg.sql','Upgrade from 3.1.2.0 to 3.2.0.0','3.2.0.0');
      hig2.upgrade('DOC','nm3120_nm3200_upg.sql','Upgrade from 3.1.2.0 to 3.2.0.0','3.2.0.0');
END;
/
COMMIT;
