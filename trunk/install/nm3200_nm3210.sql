...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3200_nm3210.sql	1.2 06/20/05
--       Module Name      : nm3200_nm3210.sql
--       Date into SCCS   : 05/06/20 12:52:12
--       Date fetched Out : 07/06/13 13:57:57
--       SCCS Version     : 1.2
--
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3200_nm3210_upg','exit') run_file
FROM dual
/
