...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3200_nm3210_upg.sql	1.11 06/30/05
--       Module Name      : nm3200_nm3210_upg.sql
--       Date into SCCS   : 05/06/30 16:18:18
--       Date fetched Out : 07/06/13 13:57:59
--       SCCS Version     : 1.11
--
...
define logfile1='nm3200_nm3210_1_&log_extension'
define logfile2='nm3200_nm3210_2_&log_extension'
spool &logfile1
...
SET VERIFY OFF
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_entry.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_detail.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_list_type.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_list.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_array_type.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_array.tyh' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_array.tyw' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'admin'||
        '&terminator'||'typ'||'&terminator'||'nm_theme_list.tyw' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm3200_nm3210_ddl_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm3200_nm3210_metadata_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
BEGIN
      hig2.upgrade('HIG','nm3200_nm3210_upg.sql','Upgrade from 3.2.0.0 to 3.2.1.0','3.2.1.0');
      hig2.upgrade('NET','nm3200_nm3210_upg.sql','Upgrade from 3.2.0.0 to 3.2.1.0','3.2.1.0');
      hig2.upgrade('DOC','nm3200_nm3210_upg.sql','Upgrade from 3.2.0.0 to 3.2.1.0','3.2.1.0');
      hig2.upgrade('AST','nm3200_nm3210_upg.sql','Upgrade from 3.2.0.0 to 3.2.1.0','3.2.1.0');
      hig2.upgrade('WMP','nm3200_nm3210_upg.sql','Upgrade from 3.2.0.0 to 3.2.1.0','3.2.1.0');
END;
/
COMMIT;
...
FROM hig_products
WHERE hpr_product IN ('HIG','NET','DOC','AST');
