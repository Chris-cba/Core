...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3210_nm3220.sql	1.1 08/15/05
--       Module Name      : nm3210_nm3220.sql
--       Date into SCCS   : 05/08/15 16:42:24
...
SELECT DECODE(UPPER('&ok_res'),'Y','&terminator'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3210_nm3220_upg','exit') run_file
FROM dual
/
...
prompt
prompt The NETWORK MANAGER upgrade scripts could NOT be FOUND IN the directory
