...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3210_nm3220_upg.sql	1.5 02/02/06
--       Module Name      : nm3210_nm3220_upg.sql
--       Date into SCCS   : 06/02/02 10:25:27
...
define logfile1='nm3210_nm3220_1_&log_extension'
define logfile2='nm3210_nm3220_2_&log_extension'
spool
...
select '&exor_base'||'nm3'||'&terminator'||'admin'||'&terminator'||'typ'||
        '&terminator'||'nm3typ_40.sql' run_file
from dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm3210_nm3220_ddl_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm3210_nm3220_metadata_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
BEGIN
      hig2.upgrade('HIG','nm3210_nm3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
      hig2.upgrade('NET','nm3210_nm3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
      hig2.upgrade('DOC','nm3210_nm3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
      hig2.upgrade('AST','nm3210_nm3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
      hig2.upgrade('WMP','nm3210_nm3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
END;
/
COMMIT;
