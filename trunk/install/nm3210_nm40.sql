...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3210_nm40.sql	1.1 02/08/06
--       Module Name      : nm3210_nm40.sql
--       Date into SCCS   : 06/02/08 12:30:11
--       Date fetched Out : 07/06/13 13:58:05
--       SCCS Version     : 1.1
--
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3210_nm40_upg','exit') run_file
FROM dual
/
