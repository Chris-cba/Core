...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3211_25jul2006.sql	1.1 07/25/06
--       Module Name      : nm3211_25jul2006.sql
--       Date into SCCS   : 06/07/25 11:39:57
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3211_25jul2006_upg.sql','exit') run_file
FROM dual
/
