...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm3211_nm3212.sql	1.1 08/07/06
--       Module Name      : nm3211_nm3212.sql
--       Date into SCCS   : 06/08/07 17:09:26
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm3211_nm3212_upg.sql','exit') run_file
FROM dual
/
