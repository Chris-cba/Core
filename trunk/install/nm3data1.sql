...
SELECT 
       ...
       ,10 FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_DOMAINS
                   WHERE HDO_DOMAIN = 'LAUNCHPAD_MODE');
--
INSERT INTO HIG_DOMAINS
       (HDO_DOMAIN
       ,HDO_PRODUCT
...
SELECT 
       ...
       ,30 FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_DOMAINS
                   WHERE HDO_DOMAIN = 'XREF_REL_TYPE');
--
INSERT INTO HIG_DOMAINS
       (HDO_DOMAIN
       ,HDO_PRODUCT
...
SELECT 
 ...
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'ADMIN TYPE GROUPINGS'
                    AND  HCO_CODE = '1');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'BOOLEAN_CONNECTORS'
                    AND  HCO_CODE = 'AND');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CALL_NM0570'
                    AND  HCO_CODE = 'DOC0150');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
       ,HCO_CODE
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CALL_NM9999'
                    AND  HCO_CODE = 'GRI0200');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
       ,HCO_CODE
...
SELECT 
       ...
       ,'Y'
       ,34
       ,to_date('20000810000000','YYYYMMDDHH24MISS')
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CONTACT_ORG_TYPE'
                    AND  HCO_CODE = 'INSURER');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
       ,HCO_CODE
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CSV_DELIMITERS'
                    AND  HCO_CODE = '');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CSV_PROCESS_SUBTYPE'
                    AND  HCO_CODE = 'F');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'CSV_PROCESS_TYPE'
                    AND  HCO_CODE = 'C');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'DIRECTORY_SEPERATOR'
                    AND  HCO_CODE = '/');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'DISCO_SUCK_TYPES'
                    AND  HCO_CODE = 'ACC');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'DISCO_VERSIONS'
                    AND  HCO_CODE = '4');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'ELEC_DRAIN_CARR'
                    AND  HCO_CODE = 'C');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'MC_INV_LD_ERR_STATUS'
                    AND  HCO_CODE = '0');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,'Y'
       ,7
       ,to_date('20001023000000','YYYYMMDDHH24MISS')
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'NM_ELEMENTS_COLUMNS'
                    AND  HCO_CODE = 'NE_GROUP');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
       ,HCO_CODE
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'POP3_HEADER_FIELDS'
                    AND  HCO_CODE = 'DATE');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
 ...
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'POP3_HEADER_FIELDS'
                    AND  HCO_CODE = 'ORIGINAL-RECIPIENT');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
       ,HCO_CODE
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'PRIVILEGE_TYPE'
                    AND  HCO_CODE = 'ALL');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'SECT_LENGTH_STATUS'
                    AND  HCO_CODE = 'E');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'SECURITY_MODES'
                    AND  HCO_CODE = 'NORMAL');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
SELECT 
       ...
       ,null FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_CODES
                   WHERE HCO_DOMAIN = 'X_ATTR_VAL_TYPES'
                    AND  HCO_CODE = '1');
--
INSERT INTO HIG_CODES
       (HCO_DOMAIN
...
--
-- Columns
-- HCL_COLOUR                     NOT NULL VARCHAR2(30)
--   HCL_PK (Pos 1)
-- HCL_VISUAL_ATTRIBUTE           NOT NULL VARCHAR2(30)
--
--
...
SELECT 
       ...
       ,'BRICK' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_COLOURS
                   WHERE HCL_COLOUR = 'Brick Pattern');
--
INSERT INTO HIG_COLOURS
       (HCL_COLOUR
       ,HCL_VISUAL_ATTRIBUTE
...
SELECT 
       ...
       ,'BRICK_LR' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_COLOURS
                   WHERE HCL_COLOUR = 'Brick Slanted L/R');
--
INSERT INTO HIG_COLOURS
       (HCL_COLOUR
       ,HCL_VISUAL_ATTRIBUTE
...
SELECT 
       ...
       ,'BRICK_RL' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_COLOURS
                   WHERE HCL_COLOUR = 'Brick Slanted R/L');
--
INSERT INTO HIG_COLOURS
       (HCL_COLOUR
       ,HCL_VISUAL_ATTRIBUTE
...
SELECT 
 ...
 WHERE NOT EXISTS (SELECT 1 FROM HIG_COLOURS
                   WHERE HCL_COLOUR = 'Hash Line Left\Right');
--
INSERT INTO HIG_COLOURS
       (HCL_COLOUR
       ,HCL_VISUAL_ATTRIBUTE
...
SELECT 
 ...
 WHERE NOT EXISTS (SELECT 1 FROM HIG_COLOURS
                   WHERE HCL_COLOUR = 'Hash Line Right\Left');
--
INSERT INTO HIG_COLOURS
       (HCL_COLOUR
       ,HCL_VISUAL_ATTRIBUTE
...
SELECT 
       ...
       ,'HIG'
       ,'Reports Server URL'
       ,'URL to get to the application server Reports Server (not 6i run_product)'
       ,''
       ,'VARCHAR2'
       ,'Y'
       ,'N' FROM DUAL
...
SELECT 
       ...
       ,'Update subordinates allowed if parent is readonly'
       ,'Y_OR_N'
       ,'VARCHAR2'
       ,'N'
       ,'N' FROM DUAL
...
SELECT 
       ...
       ,'WMP'
       ,'MSV Buffer Colour'
       ,'Colour Used to Render Web Map Buffer'
       ,''
       ,'VARCHAR2'
       ,'N'
       ,'Y' FROM DUAL
...
SELECT 
       ...
       ,'Buffer size for array fetches in nm3sdo'
       ,''
       ,'VARCHAR2'
       ,'N'
       ,'N' FROM DUAL
...
SELECT 
       ...
       ,'New enquiries will be automatically assigned this status.'
       ,'Enquiries will be automatically assigned this status in DOC0160 (Print Enquiry Details).'
       ,'Status values which allow the Completed Date to be entered.'
       ,'Status of Enquiry when Completed'
       ,'Works Order Raised'
 ...
 WHERE NOT EXISTS (SELECT 1 FROM HIG_STATUS_DOMAINS
                   WHERE HSD_DOMAIN_CODE = 'COMPLAINTS');
--
INSERT INTO HIG_STATUS_DOMAINS
       (HSD_DOMAIN_CODE
       ,HSD_PRODUCT
...
SELECT 
       ...
       ,'Not Used' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM HIG_STATUS_DOMAINS
                   WHERE HSD_DOMAIN_CODE = 'ENQUIRY_ACTION_STATUS');
--
--
--********** HIG_STATUS_CODES **********--
SET TERM ON
