...
SELECT 'DOC0201'
      ,'DOC'
      ,'Role for OLE Word Template Maintenance'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
SELECT 'DOC0202'
      ,'DOC'
      ,'Role for OLE Word Template User Maintenance'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
SELECT 'DOC_READONLY'
      ,'DOC'
      ,'Document Manager Readonly Access'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
INSERT
  INTO HIG_ROLES
      ...
      ,HRO_PRODUCT
      ,HRO_DESCR)
SELECT 'GIS_SUPERUSER'
      ,'HIG'
      ,'GIS Super User Administration Role'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
INSERT
  INTO HIG_ROLES
      ...
      ,HRO_PRODUCT
      ,HRO_DESCR)
SELECT 'HIG_USER_ADMIN'
      ,'HIG'
      ,'Highways User Administration'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
SELECT 'NET_ADMIN'
      ,'NET'
      ,'Network Manager Administration'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
SELECT 'NET_READONLY'
      ,'NET'
      ,'Network Manager Readonly Access'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
INSERT
  INTO HIG_ROLES
      ...
      ,HRO_PRODUCT
      ,HRO_DESCR)
SELECT 'PROCESS_ADMIN'
      ,'HIG'
      ,'Scheduler Job Admin Privs'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
...
SELECT 'ADMIN_UNIT'
      ...
      ,''
      ,'NAU_ADMIN_UNIT'
      ,'SUBSTR(RPAD(NAU_UNIT_CODE,4,'' ''),1,4)||'' - ''||NAU_NAME'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
