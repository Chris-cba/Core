...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm3data6.sql-arc   2.3   Aug 19 2009 10:59:04   aedwards  $
...
-- NM_SPECIAL_CHARS
--
-- select * from nm3_metadata.nm_special_chars
-- order by nsch_ascii_character
--
----------------------------------------------------------------------------------------

SET TERM ON
PROMPT nm_special_chars
SET TERM OFF
