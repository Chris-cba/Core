...
SELECT 5
      ...
      ,.017453288888888888888888888888888888889
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_UNIT_CONVERSIONS
                   WHERE UC_UNIT_ID_IN = 5
...
SELECT 6
      ...
      ,57.2957914331332649179142294734644091276
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_UNIT_CONVERSIONS
