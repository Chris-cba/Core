...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm4010_nm4020.sql	1.1 05/14/07
--       Module Name      : nm4010_nm4020.sql
--       Date into SCCS   : 07/05/14 10:43:38
--       Date fetched Out : 07/06/13 13:59:25
--       SCCS Version     : 1.1
--
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4010_nm4020_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
