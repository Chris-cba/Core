...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4010_nm4020_1_&log_extension'
define logfile2='nm4010_nm4020_2_&log_extension'
spool &logfile1
--get some db info
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4010_nm4020_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4010_nm4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
      hig2.upgrade('NET','nm4010_nm4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
      hig2.upgrade('DOC','nm4010_nm4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
      hig2.upgrade('AST','nm4010_nm4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
      hig2.upgrade('WMP','nm4010_nm4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
END;
/
COMMIT;
SET HEADING OFF
