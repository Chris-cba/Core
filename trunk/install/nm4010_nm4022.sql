...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/nm3/install/nm4010_nm4022.sql-arc   2.1   Jul 04 2013 14:10:06   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4010_nm4022.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4010_nm4022_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
