...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/nm3/install/nm4010_nm4022_upg.sql-arc   2.1   Jul 04 2013 14:09:48   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4010_nm4022_upg.sql  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4010_nm4022_1_&log_extension'
define logfile2='nm4010_nm4022_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4010_nm4022_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4010_nm4022_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4010_nm4022_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.2','4.0.2.2');
      hig2.upgrade('NET','nm4010_nm4022_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.2','4.0.2.2');
      hig2.upgrade('DOC','nm4010_nm4022_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.2','4.0.2.2');
      hig2.upgrade('AST','nm4010_nm4022_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.2','4.0.2.2');
      hig2.upgrade('WMP','nm4010_nm4022_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.2','4.0.2.2');
END;
/
COMMIT;
SET HEADING OFF
