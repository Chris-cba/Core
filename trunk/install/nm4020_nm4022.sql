...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4020_nm4022.sql-arc   2.0   Nov 28 2007 08:59:16   jwadsworth  $
--       Module Name      : $Workfile:   nm4020_nm4022.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4020_nm4022_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
