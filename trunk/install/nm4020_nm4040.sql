...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4020_nm4040.sql-arc   3.1   Jul 04 2013 14:10:08   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4020_nm4040.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4020_nm4040_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
