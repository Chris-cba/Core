...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4020_nm4040_upg.sql-arc   3.1   Jul 04 2013 14:10:08   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4020_nm4040_upg.sql  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4020_nm4040_1_&log_extension'
define logfile2='nm4020_nm4040_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4020_nm4040_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4020_nm4040_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4020_nm4040_upg.sql','Upgrade from 4.0.2.0 to 4.0.4.0','4.0.4.0');
      hig2.upgrade('NET','nm4020_nm4040_upg.sql','Upgrade from 4.0.2.0 to 4.0.4.0','4.0.4.0');
      hig2.upgrade('DOC','nm4020_nm4040_upg.sql','Upgrade from 4.0.2.0 to 4.0.4.0','4.0.4.0');
      hig2.upgrade('AST','nm4020_nm4040_upg.sql','Upgrade from 4.0.2.0 to 4.0.4.0','4.0.4.0');
      hig2.upgrade('WMP','nm4020_nm4040_upg.sql','Upgrade from 4.0.2.0 to 4.0.4.0','4.0.4.0');
END;
/
COMMIT;
SET HEADING OFF
