...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4040_nm4041.sql-arc   2.1   Jul 04 2013 14:10:26   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4040_nm4041.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4040_nm4041_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
