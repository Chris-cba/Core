...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4040_nm4041_1_&log_extension'
define logfile2='nm4040_nm4041_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4040_nm4041_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4040_nm4041_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4040_nm4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
      hig2.upgrade('NET','nm4040_nm4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
      hig2.upgrade('DOC','nm4040_nm4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
      hig2.upgrade('AST','nm4040_nm4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
      hig2.upgrade('WMP','nm4040_nm4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
END;
/
COMMIT;
SET HEADING OFF
