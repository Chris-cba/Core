...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4040_nm4050_upg.sql-arc   3.0   Apr 14 2008 10:15:00   jwadsworth  $
--       Module Name      : $Workfile:   nm4040_nm4050_upg.sql  $
--       Date into PVCS   : $Date:   Apr 14 2008 10:15:00  $
--       Date fetched Out : $Modtime:   Apr 14 2008 10:14:20  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4040_nm4050_1_&log_extension'
define logfile2='nm4040_nm4050_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4040_nm4050_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4040_nm4050_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4040_nm4050_upg.sql','Upgrade from 4.0.4.0 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('NET','nm4040_nm4050_upg.sql','Upgrade from 4.0.4.0 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('DOC','nm4040_nm4050_upg.sql','Upgrade from 4.0.4.0 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('AST','nm4040_nm4050_upg.sql','Upgrade from 4.0.4.0 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('WMP','nm4040_nm4050_upg.sql','Upgrade from 4.0.4.0 to 4.0.5.0','4.0.5.0');
END;
/
COMMIT;
SET HEADING OFF
