...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4046_nm4050_upg.sql-arc   3.2   Jul 04 2013 14:10:28   James.Wadsworth  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4046_nm4050_1_&log_extension'
define logfile2='nm4046_nm4050_2_&log_extension'
spool &logfile1
--get some db info
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4046_nm4050_upg.sql','Upgrade from 4.0.4.6 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('NET','nm4046_nm4050_upg.sql','Upgrade from 4.0.4.6 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('DOC','nm4046_nm4050_upg.sql','Upgrade from 4.0.4.6 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('AST','nm4046_nm4050_upg.sql','Upgrade from 4.0.4.6 to 4.0.5.0','4.0.5.0');
      hig2.upgrade('WMP','nm4046_nm4050_upg.sql','Upgrade from 4.0.4.6 to 4.0.5.0','4.0.5.0');
END;
/
COMMIT;
SET HEADING OFF
