...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4051_nm4052_upg.sql-arc   3.0   Feb 03 2009 15:39:50   malexander  $
--       Module Name      : $Workfile:   nm4051_nm4052_upg.sql  $
--       Date into PVCS   : $Date:   Feb 03 2009 15:39:50  $
--       Date fetched Out : $Modtime:   Feb 03 2009 15:38:58  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4051_nm4052_1_&log_extension'
define logfile2='nm4051_nm4052_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'HIG'
                          ...
                          ,p_allowed_old_version_1 => '4.0.5.1'
                          );
END;
/
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4051_nm4052_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm4051_nm4052_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4051_nm4052_upg.sql','Upgrade from 4.0.5.1 to 4.0.5.2','4.0.5.2');
      hig2.upgrade('NET','nm4051_nm4052_upg.sql','Upgrade from 4.0.5.1 to 4.0.5.2','4.0.5.2');
      hig2.upgrade('DOC','nm4051_nm4052_upg.sql','Upgrade from 4.0.5.1 to 4.0.5.2','4.0.5.2');
      hig2.upgrade('AST','nm4051_nm4052_upg.sql','Upgrade from 4.0.5.1 to 4.0.5.2','4.0.5.2');
      hig2.upgrade('WMP','nm4051_nm4052_upg.sql','Upgrade from 4.0.5.1 to 4.0.5.2','4.0.5.2');
END;
/
COMMIT;
SET HEADING OFF
