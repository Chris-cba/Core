...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4052_nm4053.sql-arc   3.0   Mar 02 2009 12:27:56   malexander  $
--       Module Name      : $Workfile:   nm4052_nm4053.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4052_nm4053_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
