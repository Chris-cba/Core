...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4052_nm4100.sql-arc   3.1   Jul 04 2013 14:15:40   James.Wadsworth  $
--       Module Name      : $Workfile:   nm4052_nm4100.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm405x_nm4100_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
