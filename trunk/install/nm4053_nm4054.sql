...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4053_nm4054.sql-arc   3.0   Mar 23 2009 12:22:30   malexander  $
--       Module Name      : $Workfile:   nm4053_nm4054.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4053_nm4054_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
