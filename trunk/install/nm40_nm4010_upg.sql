...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm40_nm4010_upg.sql	1.2 04/13/07
--       Module Name      : nm40_nm4010_upg.sql
--       Date into SCCS   : 07/04/13 11:10:52
--       Date fetched Out : 07/06/13 13:59:21
--       SCCS Version     : 1.2
--
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm40_nm4010_1_&log_extension'
define logfile2='nm40_nm4010_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm40_nm4010_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'nm3'||'&terminator'||'install'||
        '&terminator'||'nm40_nm4010_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm40_nm4010_upg.sql','Upgrade from 4.0 to 4.0.1.0','4.0.1.0');
      hig2.upgrade('NET','nm40_nm4010_upg.sql','Upgrade from 4.0 to 4.0.1.0','4.0.1.0');
      hig2.upgrade('DOC','nm40_nm4010_upg.sql','Upgrade from 4.0 to 4.0.1.0','4.0.1.0');
      hig2.upgrade('AST','nm40_nm4010_upg.sql','Upgrade from 4.0 to 4.0.1.0','4.0.1.0');
      hig2.upgrade('WMP','nm40_nm4010_upg.sql','Upgrade from 4.0 to 4.0.1.0','4.0.1.0');
END;
/
COMMIT;
SET HEADING OFF
