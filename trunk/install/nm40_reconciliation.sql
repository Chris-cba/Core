...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)nm40_reconciliation.sql	1.1 12/04/06
--       Module Name      : nm40_reconciliation.sql
--       Date into SCCS   : 06/12/04 17:09:17
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm40_nm40_upg','exit') run_file
FROM dual
/
