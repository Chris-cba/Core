...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4100_nm4101.sql-arc   3.0   Nov 12 2009 16:40:30   malexander  $
--       Module Name      : $Workfile:   nm4100_nm4101.sql  $
--       Date into PVCS   : $Date:   Nov 12 2009 16:40:30  $
--       Date fetched Out : $Modtime:   Nov 12 2009 15:23:38  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4100_nm4101_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
