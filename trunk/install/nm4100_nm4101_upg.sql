...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4100_nm4101_upg.sql-arc   3.0   Nov 12 2009 16:40:30   malexander  $
--       Module Name      : $Workfile:   nm4100_nm4101_upg.sql  $
--       Date into PVCS   : $Date:   Nov 12 2009 16:40:30  $
--       Date fetched Out : $Modtime:   Nov 12 2009 15:57:50  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4100_nm4101_1_&log_extension'
define logfile2='nm4100_nm4101_2_&log_extension'
spool &logfile1
--get some db info
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4100_nm4101_upg.sql','Upgrade from 4.1.0.0 to 4.1.0.1','4.1.0.1');
      hig2.upgrade('NET','nm4100_nm4101_upg.sql','Upgrade from 4.1.0.0 to 4.1.0.1','4.1.0.1');
      hig2.upgrade('DOC','nm4100_nm4101_upg.sql','Upgrade from 4.1.0.0 to 4.1.0.1','4.1.0.1');
      hig2.upgrade('AST','nm4100_nm4101_upg.sql','Upgrade from 4.1.0.0 to 4.1.0.1','4.1.0.1');
      hig2.upgrade('WMP','nm4100_nm4101_upg.sql','Upgrade from 4.1.0.0 to 4.1.0.1','4.1.0.1');
END;
/
COMMIT;
SET HEADING OFF
