...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4200_nm4210_upg.sql-arc   3.0   Apr 12 2010 11:18:42   malexander  $
--       Module Name      : $Workfile:   nm4200_nm4210_upg.sql  $
--       Date into PVCS   : $Date:   Apr 12 2010 11:18:42  $
--       Date fetched Out : $Modtime:   Apr 12 2010 11:16:38  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='nm4200_nm4210_1_&log_extension'
define logfile2='nm4200_nm4210_2_&log_extension'
spool &logfile1
--get some db info
...
SET TERM OFF
BEGIN
      hig2.upgrade('HIG','nm4200_nm4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
      hig2.upgrade('NET','nm4200_nm4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
      hig2.upgrade('DOC','nm4200_nm4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
      hig2.upgrade('AST','nm4200_nm4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
      hig2.upgrade('WMP','nm4200_nm4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
END;
/
COMMIT;
SET HEADING OFF
