...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4200_nm4300.sql-arc   3.0   Sep 16 2010 15:54:18   Mike.Alexander  $
--       Module Name      : $Workfile:   nm4200_nm4300.sql  $
--       Date into PVCS   : $Date:   Sep 16 2010 15:54:18  $
--       Date fetched Out : $Modtime:   Sep 16 2010 15:46:06  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm42x0_nm4300_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
