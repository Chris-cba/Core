...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4210_nm4300_metadata_upg.sql-arc   3.5   Oct 14 2010 14:12:52   Mike.Alexander  $
--       Module Name      : $Workfile:   nm4210_nm4300_metadata_upg.sql  $
--       Date into PVCS   : $Date:   Oct 14 2010 14:12:52  $
--       Date fetched Out : $Modtime:   Oct 14 2010 14:09:50  $
...
INSERT INTO NM_INV_TYPE_ATTRIBS_ALL
 ...
 VALUES
   ('PRO$', 'HPAL_PROCESS_TYPE_ID', 'N', 9, 'N', 
    ...
    To_Date('05/05/2010 17:39:47', 'MM/DD/YYYY HH24:MI:SS'), 'DORSET', 'DORSET', 'SELECT 

HPT_NAME,HPT_DESCR,HPT_PROCESS_TYPE_ID FROM HIG_PROCESS_TYPES
ORDER BY HPT_NAME', 'N', 
    NULL, 'N', 'UPPER');
INSERT INTO NM_INV_TYPE_ATTRIBS_ALL
   (ITA_INV_TYPE, ITA_ATTRIB_NAME, ITA_DYNAMIC_ATTRIB, ITA_DISP_SEQ_NO, ITA_MANDATORY_YN, 
...
INSERT INTO NM_INV_TYPE_ATTRIBS_ALL
 ...
 VALUES
   ('PRO$', 'HPAL_SUCCESS_FLAG', 'N', 14, 'N', 
    ...
    To_Date('05/10/2010 14:11:18', 'MM/DD/YYYY HH24:MI:SS'), 'HIGHWAYS', 'HIGHWAYS', 'SELECT HCO_CODE,HCO_MEANING,HCO_CODE 

CODE FROM HIG_CODES WHERE 
