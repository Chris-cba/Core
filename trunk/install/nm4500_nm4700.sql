...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4500_nm4700.sql-arc   1.0   Aug 23 2013 10:25:04   Rob.Coupe  $
--       Module Name      : $Workfile:   nm4500_nm4700.sql  $
--       Date into PVCS   : $Date:   Aug 23 2013 10:25:04  $
--       Date fetched Out : $Modtime:   Aug 23 2013 10:24:26  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4500_nm4700_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
