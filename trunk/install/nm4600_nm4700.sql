...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/nm3/install/nm4600_nm4700.sql-arc   1.0   Jul 12 2013 10:25:36   Rob.Coupe  $
--       Module Name      : $Workfile:   nm4600_nm4700.sql  $
--       Date into PVCS   : $Date:   Jul 12 2013 10:25:36  $
--       Date fetched Out : $Modtime:   Jul 11 2013 09:03:12  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4600_nm4700_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
