...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm4700_nm4800.sql-arc   1.0   Jan 09 2019 10:25:34   Chris.Baugh  $
--       Module Name      : $Workfile:   nm4700_nm4800.sql  $
--       Date into PVCS   : $Date:   Jan 09 2019 10:25:34  $
--       Date fetched Out : $Modtime:   May 16 2018 15:36:50  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'nm3'||'&terminator'||
        'install'||'&terminator'||'nm4700_nm4800_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
