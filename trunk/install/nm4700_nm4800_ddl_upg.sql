...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/nm4700_nm4800_ddl_upg.sql-arc   1.0   Jan 09 2019 10:25:34   Chris.Baugh  $
--       Module Name      : $Workfile:   nm4700_nm4800_ddl_upg.sql  $
--       Date into PVCS   : $Date:   Jan 09 2019 10:25:34  $
--       Date fetched Out : $Modtime:   Dec 18 2018 09:26:36  $
...
CREATE INDEX NAJX_INV_IDX ON NM_ASSET_TYPE_JUXTAPOSITIONS
 (NAJX_INV_TYPE
 ,NAJX_NJXT_ID)
/
...
/
 ...
 ADD (CONSTRAINT NIG_PK_IDX PRIMARY KEY 
...
ALTER TABLE LB_INV_SECURITY ADD (CONSTRAINT
...
ALTER TABLE LB_TYPES ADD (CONSTRAINT
...
ALTER TABLE LB_UNITS ADD (CONSTRAINT
...
ALTER TABLE NM_ASSET_GEOMETRY_ALL ADD (CONSTRAINT
...
ALTER TABLE NM_ASSET_LOCATIONS_ALL ADD (CONSTRAINT
...
ALTER TABLE NM_ASSET_TYPE_JUXTAPOSITIONS ADD (CONSTRAINT
...
ALTER TABLE NM_JUXTAPOSITIONS ADD (CONSTRAINT
...
ALTER TABLE NM_LOCATIONS_ALL ADD (CONSTRAINT
...
ALTER TABLE NM_LOCATION_GEOMETRY ADD (CONSTRAINT
