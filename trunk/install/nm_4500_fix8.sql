...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/nm_4500_fix8.sql-arc   3.2   Jul 04 2013 13:48:08   James.Wadsworth  $
...
-- Spool to Logfile
--
define logfile1='nm_4500_fix8_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT log_nm_4500_fix8.sql 
--
SET FEEDBACK ON
start log_nm_4500_fix8.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
