--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/nm3/install/nm_4700_fix10.sql-arc   1.0   Nov 05 2014 14:35:54   Upendra.Hukeri  $
--       Module Name      : $Workfile:   nm_4700_fix10.sql  $ 
--       Date into PVCS   : $Date:   Nov 05 2014 14:35:54  $
--       Date fetched Out : $Modtime:   Nov 05 2014 14:29:40  $
...
-- Spool to Logfile
--
DEFINE logfile1='nm_4700_fix10_&log_extension'
SPOOL &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON
PROMPT log_nm_4700_fix10.sql
--
SET FEEDBACK ON
start log_nm_4700_fix10.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
