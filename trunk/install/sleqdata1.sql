...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/nm3/install/sleqdata1.sql-arc   1.0   Jun 18 2018 16:26:48   Chris.Baugh  $
--       Module Name      : $Workfile:   sleqdata1.sql  $
--       Date into PVCS   : $Date:   Jun 18 2018 16:26:48  $
...
-- NM_INV_DOMAINS_ALL
--
-- select * from nm3_slm_metadata.nm_inv_domains_all
-- order by id_domain
--
----------------------------------------------------------------------------------------
SET TERM ON
...
INSERT
  INTO NM_INV_DOMAINS_ALL
      ...
      ,ID_MODIFIED_BY
      ,ID_CREATED_BY)
SELECT 'SLEQ_COLUMN_ROOT_PROTECTION'
...
INSERT
  INTO NM_INV_DOMAINS_ALL
      ...
      ,ID_MODIFIED_BY
      ,ID_CREATED_BY)
SELECT 'SLEQ_DESIGNED_FOR_FATIGUE'
...
INSERT
  INTO NM_INV_DOMAINS_ALL
      ...
      ,ID_MODIFIED_BY
      ,ID_CREATED_BY)
SELECT 'SLEQ_EXTERNAL_INFLUENCE'
      ,'EXTERNAL INFLUENCES'
      ,to_date('19000101000000','YYYYMMDDHH24MISS')
      ,null
      ,'VARCHAR2'
...
INSERT
  INTO NM_INV_DOMAINS_ALL
      ...
      ,ID_MODIFIED_BY
      ,ID_CREATED_BY)
SELECT 'SLEQ_LANTERN_DISTRIBUTION'
...
INSERT
  INTO NM_INV_DOMAINS_ALL
      ...
      ,ID_MODIFIED_BY
      ,ID_CREATED_BY)
SELECT 'SLEQ_LANTERN_PROTECTION'
      ,'LANTERN PROTECTION'
      ,to_date('19000101000000','YYYYMMDDHH24MISS')
      ,null
      ,'VARCHAR2'
...
-- NM_INV_ATTRI_LOOKUP_ALL
--
-- select * from nm3_slm_metadata.nm_inv_attri_lookup_all
-- order by ial_domain
--         ,ial_value
--         ,ial_start_date
--
...
-- NM_INV_TYPES_ALL
--
-- select * from nm3_slm_metadata.nm_inv_types_all
...
-- NM_INV_TYPE_ATTRIBS_ALL
--
-- select * from nm3_slm_metadata.nm_inv_type_attribs_all
...
-- NM_INV_TYPE_ROLES
--
-- select * from nm3_slm_metadata.nm_inv_type_roles
